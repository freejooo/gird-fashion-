...
<br />
<div align="center">
  <a href="https://github.com/freejooo/gird-fashion-">
    <!-- <img src="client/public/logo-big.png" alt="Logo" height="80"> -->
  </a>

  <h3 align="center">Style Spectrum</h3>

  <p align="center">
    Your custom-tailored AI style guide!
    <br />
    <br />
    <a href="https://youtu.be/tKpt8PQw_aQ">Watch Preview</a>
    ·
    <a href="https://github.com/freejooo/gird-fashion-/issues">Submit an Issue</a>
    ·
    <a href="https://github.com/freejooo/gird-fashion-/issues">Suggest an Enhancement</a>
  </p>
</div>
...
<!-- TABLE OF CONTENTS -->
  ...
  <ol>
    <li>
      <a href="#about-the-project">Overview of the Initiative</a>
      <ul>
        <li><a href="#built-with">Constructed Using</a></li>
      </ul>
    </li>
    <li>
      <a href="#getting-started">Initiation Steps</a>
      <ul>
        <li><a href="#prerequisites">Essentials</a></li>
...
2. Clone the repo
   ```sh
   git clone https://github.com/freejooo/gird-fashion-
   ```
